...
namespace StaticMembersApplication
{
    ...
    static class ProductManager //kopyası oluşturulmayacağı için static oluşturdum!
    {
        static Product[] Products;

        static ProductManager()
        {
            Products = new Product[5]; //product manager'ın constructor'ı olşturuluğu için statik olan product'ın içini doldurdum!
        ...
        public static Product[] GetProducts() //dışarıdan bu bilgilere ulaşılabilmesi için public method oluşturdum!
        {
            return Products;
        }
